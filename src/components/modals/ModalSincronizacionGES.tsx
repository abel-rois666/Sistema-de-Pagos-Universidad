  ...
  const iniciarEscaneo = async () => {
    ...
    try {
      ...
      for (let i = 0; i < alumnosWeb.length; i++) {
        ...
        try {
          const res = await fetch(`${baseUrl}/api/legacy/alumnos/buscar?q=` + encodeURIComponent(alumno.nombre_completo));
        ...
        >
          ...
          <div className="flex border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex-shrink-0 px-6 pt-2">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === 'listos'
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === 'conflictos'
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === 'no_encontrados'
