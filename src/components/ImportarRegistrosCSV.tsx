...
export default function ImportarRegistrosCSV({ alumnos, activeCiclo: activeCicloProp, ciclos, onImport, onClose }: ImportarRegistrosCSVProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }} transition={{ duration: 0.2 }} className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-900">Importar Registros de Pago</h2>
                            <p className="text-sm text-gray-500">Ciclo activo: <span className="font-semibold text-blue-600">{activeCiclo?.nombre || 'Ninguno'}</span></p>
                        </div>
                    </div>
                        ...
                        <div className="p-6 space-y-6">
                            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <p className="font-semibold text-blue-900 mb-1">Descarga la plantilla oficial</p>
                            ...
                            >
                                ...
                                <p className="text-gray-700 font-semibold text-lg mb-1">Arrastra el CSV de Pagos aquí</p>
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="bg-gray-50 border-b border-gray-200">
                                            ...
                                            <th className="px-4 py-3 text-left text-xs font-bold text-gray-500 uppercase">Cobro Total</th>
                                            <th className="px-4 py-3 text-left text-xs font-bold text-gray-500 uppercase">Conceptos</th>
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {parsedRows.map(row => (
                                            <tr key={row.rowIndex} className={row.errors.length > 0 ? 'bg-red-50' : 'hover:bg-gray-50'}>
                                                ...
                                                <td className="px-4 py-3 font-semibold text-gray-800">{row.nombre_alumno || '—'}</td>
                                                <td className="px-4 py-3 text-gray-600">${row.total_final.toFixed(2)}</td>
                    ...
                    {step === 3 && importResult && (
                        <div className="text-center py-8 space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500">Los recibos han sido registrados en la base de datos.</p>
                            </div>
