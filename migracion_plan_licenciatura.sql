-- ======================================================================================
-- MIGRACIÓN PARA INDEPENDIZAR PROGRAMAS DE ESTUDIO (LICENCIATURA) A NIVEL PLAN
...
-- 2. Anadir la columna licenciatura a la tabla planes_pago
ALTER TABLE public.planes_pago ADD COLUMN IF NOT EXISTS licenciatura TEXT;

-- 3. Recrear la Vista Integrando la Licenciatura Autonoma usando COALESCE
